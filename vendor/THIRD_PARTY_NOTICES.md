...
The result card's CSS flip structure is adapted from
[`marcreichel/css-flip-card`](https://github.com/marcreichel/css-flip-card),
licensed under the MIT License. See `css-flip-card-LICENSE`.

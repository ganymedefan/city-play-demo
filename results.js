...
function showResult(){
 ...
 name.innerHTML='';
 for(const row of [names[result.type].slice(0,2),names[result.type].slice(2,4)]){const span=document.createElement('span');span.textContent=row;name.append(span);}
